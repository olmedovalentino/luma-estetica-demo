...
export function SiteFooter({ whatsappUrl }: SiteFooterProps) {
  return (
    <footer className="border-t border-white/70 bg-[#3e4634] text-white">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-10 sm:px-6 lg:grid-cols-[1.15fr_0.75fr_0.9fr] lg:px-8">
        <div>
          ...
          <p className="mt-4 max-w-md text-sm leading-7 text-white/75">{site.footerDescription}</p>
        </div>

        <div>
          <p className="text-sm font-semibold uppercase tracking-[0.28em] text-[#e8dccb]">
            Navegación
          </p>
