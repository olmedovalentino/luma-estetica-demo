...
export function ButtonLink({
  ...
  const styles = {
    primary:
      "border border-cyan-200/45 bg-cyan-200/10 text-cyan-50 shadow-[0_0_34px_rgba(34,211,238,0.18)] hover:-translate-y-0.5 hover:border-cyan-100 hover:bg-cyan-200/16",
    secondary:
